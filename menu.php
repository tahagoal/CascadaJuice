...
<body id="body" class="no_scroll">
    ...
    <section class="ftco-cover overlay" id="section-home">
        <div class="slider" id="slider">
        	<div class="background_hero_menu">
        		<div class="container hero_container">
        			<div class="row">
        				<div class="col-sm-6">
        					<h1 data-aos="fade-up" style="letter-spacing: 4px;">Menu</h1>
        				</div>
        			</div>
        		</div>
        	</div>
            ...
            <div class="section-2-blocks-wrapper row no-gutters">
                <div class="text col-md-8 offset-2">
                    ...
                    <div class="text-inner center align-self-start" data-aos="fade-up">
                        ...
                        <p style="text-align: center;" class="why_par">The journey from regular coffee shops to CASCADA!
                        <br>
                        <br>
                        We are group of health-conscious guys who wanted to create an unconditional experience for our healthy peers; because nowadays, we are surrounded by harmful food and beverages that we used to take on a daily basis even we are aware of their harmfulness.
						</p>
                    </div>
                </div>
                <?php 
                ...
                <?php if($counter%2 == 0): ?>
	                <div class="col-md-8 col-sm-12 offset-2">
	                	<div class="menu_hor_card" data-aos="fade-up">
	                		<div class="image_left">
	                			<img class="plate_menu_img" src="<?php echo $image['url']; ?>">
	                		</div>
	                		<div class="details_right">
	                			<h3> <?php echo $title ?> </h3>
	                			<p class="white-text"><?php echo $text ?></p>
	                		</div>
	                	</div>
	                </div>
